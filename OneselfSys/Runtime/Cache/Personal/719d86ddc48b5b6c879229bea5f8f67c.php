...
<div id="content">
	...
	<div id="per-lyt">
 		...
 		<div class="cnt">
 			<title>我的帖子-<?php echo $title; ?></title>
<div id='my-tie'>
	<div class='search-nav'>
		<span class="selected-nav-tie nav-tie">全部</span>
		<span class='nav-tie'>文字</span>
		<span class='nav-tie'>图片</span>
		<button class='btn btn-info btn-publish' style='*margin-top:1px;'>我要发帖</button>
	...
	<span style='display:block;color:#999;line-height:30px;'>共0个帖子</span>
